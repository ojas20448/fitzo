...
const HomeScreen: React.FC = () => {
    ...
    const loadHomeData = async (showLoader = true) => {
        ...
        try {
            ...
            // The daily insight is a decorative strip, and it is generated by Gemini —
            // measured at ~6-7s in production. Awaiting it inside the Promise.all above
            // meant the whole skeleton waited on it, which is what produced the
            // "Server is waking up, hang tight..." banner at 6s on a server that was
            // answering /api/health in 200ms. It fills in on its own now, or not at all.
